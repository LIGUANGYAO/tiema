			...
			<div class="content">
				<div id="zjl" style="display:none" class="boxcontent boxwhite">
					<div class="box">
						...
						<div class="Detail">
						<p>您中了：<span class="red" id="pr1"></span>&nbsp;</p>
...
<html>
	...
	<body data-role="page" class="activity-scratch-card-winning">
		...
		<div class="main">
			<div class="cover">
				<img src="wheel/images/activity-scratch-card-bannerbg.png" />
				<div id="prize">
				</div>
				<div id="scratchpad">
				</div>
			...
			<div class="content">
				...
				<div class="boxcontent boxwhite">
					<div class="box">
						...
						<div class="Detail">
                            <p>
                            <b style="font-size:15px"> 活动说明<br /></b>
                            
1、	抽中代金券可在个人中心→会员中心查询。<br />
2、	所有代金券仅限在大华家纺实体店使用，店铺地址可在：品牌中心→门店查询中查找。<br />
3、	代金券不能兑现金、不找零。<br />
4、	如遇店铺有其他活动，活动不能重复。<br />
5、	每张券仅能使用一次，请在有效期内使用。<br />
6、	在店铺使用代金券时请付款前向店员出示中奖码。<br />
7、	抽中一、二等奖的，请在个人中心→向在线客服咨询兑奖，将中奖码报给客服核对。并在微信商城里用0.1元拍对应的一、二等奖的链接，填写好收货人及地址、电话，便于公司发货。<br />
8、	非包邮区域：港、澳、台、新疆、西藏、国外等较远区域，详情可咨询客服人员。<br />
9、	本活动解释权归大华家纺有限公司所有。
