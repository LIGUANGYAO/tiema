...
if ($_REQUEST['act'] == 'default') {
    ...
    $activity = "select a.activity_sn,a.activity_name,a.tzsy,a.hd_number,a.add_time,a.limit_time,a.start_time,a.end_time,b.* from activity a , activity_mx b  where a.ac_lx=1 and a.tzsy=0 and (a.start_time<='".$whell."' and a.end_time>'".$whell."') and a.activity_sn=b.p_id order by a.sort_no desc";
    ...
    if (empty($activity)) {
            ...
            $data1 = array("error" => "activend", "msg" => "该时段无大转盘活动,活动时间请留意微信公众号");
