...
<title>砸金蛋活动</title>
<link href="css/zadan/css/guajiang/css/activity-style.css" rel="stylesheet" type="text/css">
<style type="text/css">
#txt {
	color: #000000;
}
...
.eggBox{background:url(css/zadan/css/guajiang/images/egg_1.png) no-repeat bottom;width:158px;padding-top:15px;margin-top:50px; height:187px;cursor:pointer;position:relative;margin-left:70px;} 
.curr{background:url(css/zadan/css/guajiang/images/egg_2.png) no-repeat bottom;cursor:default;z-index:300;} 
.curr sup{position:absolute;width:232px;height:181px;top:-36px;left:-34px;background:url(css/zadan/css/guajiang/images/img-5.png) no-repeat;z-index:800;} 
.curr sup.win{background:url(css/zadan/css/guajiang/images/img-4.png) no-repeat;}
.hammer{background:url(css/zadan/css/guajiang/images/img-6.png) no-repeat;width:74px;height:87px;position:absolute;  
...
<script   src="css/zadan/css/guajiang/js/jquery.js" type="text/javascript"></script>
<script   src="css/zadan/css/guajiang/js/wScratchPad.js" type="text/javascript"></script>
<!--
<if condition="$Zadan['usenums'] eq 2">
<div class="main">
		<div class="content" style="margin-top:-5px">
			<div class="boxcontent boxwhite">
				<div class="box">
					...
					<p>尊敬的 <font color='red'> {weikucms:$Zadan.uname} </font> 您已经中过 <strong><font color='red'>{weikucms:$Zadan.winprize}</font></strong> 奖了,<br />兑奖号： <font color='red'>{weikucms:$Zadan.sncode}</font></p>	
...
<if condition="$Zadan['usenums'] eq 3">
	<div class="main">
		<div class="banner"><img src="css/zadan/css/guajiang/images/activity-scratch-card-end2.jpg"></div>
		<div class="content" style="margin-top:-5px">
			<div class="boxcontent boxwhite">
				<div class="box">
					<div class="title-brown">活动结束说明：</div>
					<div class="Detail">
						<p>{weikucms:$Zadan.endinfo}.</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="box">
			...
			<div class="Detail">
				...
				<!--	<input name=""  class="px" id="wechaname" value="" type="text" placeholder="请输入您的微信号">-->
					<input name=""  id="wechaid" value="{weikucms:$Zadan.wecha_id}" type="hidden">
					<input name=""  id="lid" value="{weikucms:$Zadan.lid}" type="hidden">
				</p><p>
				<p>
	...
	<div class="boxcontent boxwhite">
		<div class="box">
            ...
            <p>
								...
								}else{echo 0;}?>次机会!这是您第<a id="lo_sum"></a>次砸蛋
							</p>
...
<script src="css/zadan/css/guajiang/js/alert.js" type="text/javascript"></script>
<style type="text/css">
.window {
	width:290px;
	position:absolute;
...
<script type="text/javascript">
/*window.sncode = "{weikucms:$Zadan.sn}";*/
window.prize = "{weikucms:$Zadan.winprize}";
var winprize  = "{weikucms:$Zadan.winprize}";
var zjl = "0";	
var goon = true;
...
//			},"json")
				...
				$.post('wheel2.php?act=setTel', submitData,
				function(data) {
					if (data.success == true) {
						alert(data.msg);
