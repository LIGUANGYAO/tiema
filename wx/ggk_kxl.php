			...
			<div class="content">
				<div id="zjl" style="display:none" class="boxcontent boxwhite">
					<div class="box">
						...
						<div class="Detail">
						<p>您中了：<span class="red" id="pr1"></span>&nbsp;等奖,请前往个人中心查看中奖信息</p>
...
<html>
	...
	<body data-role="page" class="activity-scratch-card-winning">
		...
		<div class="main">
			<div class="cover" >
			     <img src="wheel/images/03.png"  >
				
                <div id="addd2">
                刮奖区
				</div>
                <div id="prize" style="background-color: #fff;">
			...
			<div class="content">
				<div id="zjl" style="display:none" class="boxcontent boxwhite">
					<div class="box">
						...
						<div class="Detail" >
						<p>您中了：<span class="red" id="pr1"></span>&nbsp;等奖<br/>感谢您对此次活动的关注！<br/>
                
                        </p>
                        <p class="red" >请前往 个人中心 查看中奖记录</p>
			         <!--	<p class="red" >兑奖码：<span class="red" id="pr_sn"></span></p>
							<p class="red"></p> 
							<p>
								<input name="" class="px" id="tel" value="" type="text" placeholder="用户请输入您的手机号">
				...
				<div class="boxcontent boxwhite">
					<div class="box"  >
						<div class="title-brown" >
							<span style="z-index:9999; text-align: center;">
								奖项设置
							</span>
						</div>
						<div class="Detail">
                            ...
                            <p>
								•一等奖： <?php if(empty($activity)){echo "礼品1";}
                                else{echo $activity[0]['prize1_jpms'];}?>,每日10名。
							</p>
							<p>
								•二等奖： <?php if(empty($activity)){echo "礼品2";}
                                else{echo $activity[0]['prize2_jpms'];}?>,每日50名。
							</p>
							<p>
                                •三等奖： <?php if(empty($activity)){echo "礼品3";}
                                else{echo $activity[0]['prize3_jpms'];}?>,每日100名。
							</p>
					...
					<div class="box">
						...
						<div class="Detail">
                             ...
                             <!--
                               ...
                               •每天登陆即有	<?php if(!empty($hd_number)){echo $hd_number;
								}else{echo 0;}?>次刮奖机会，用完即止
							</p>
							<p  class="red">
							•抵用券可在我开通微信服务的门店或官方商城使用，该券不兑换现金不找零，逾期无效<br>
                            •点击个人中心查看和兑换中奖记录
            ...
            <!--
            	<div id="nextone" style="display:none1" class="boxcontent boxwhite">
					<div class="box">
								...
								<p >
									<input class="pxbtn2" name="提 交" onclick="location='ggk.php?m=<?php echo $openid;?>'" id="save-btn" type="button" value="再来一次">
								</p>
