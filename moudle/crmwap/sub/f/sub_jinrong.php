...
function get_jinrong_list($Nu, $ma, $sql)
{
    ...
    if (isset($_REQUEST['m_key'])) {
        ...
        $f2="";
        $f2.="jinrong_sn like '%" . trim($_REQUEST['m_key']) . "%' or ";
   
        $f2.="jinrong_name like '%" . trim($_REQUEST['m_key']) . "%' ";
    ...
    if(isset($_REQUEST['leixing']))
    {
        if(trim($_REQUEST['leixing'])=='')
        {
            
        }
        else
        {
            $filer1 .=" and leixing = '" . trim($_REQUEST['leixing'])."'";    
        }
...
function get_jinrong_mx($ma,$sql)
{   
...
function update_jinrong_mx($tb,$field,$u_id,$time_f)
{   
...
function insert_jinrong_mx($tb,$field,$time_f)
{
    $array = explode(",",$field);
