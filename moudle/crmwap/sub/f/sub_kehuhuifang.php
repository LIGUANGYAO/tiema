...
function get_kehuhuifang_list($Nu, $ma, $sql)
{
    ...
    if (isset($_REQUEST['m_key'])) {
        ...
        $f2="";
        $f2.="kehuhuifang_sn like '%" . trim($_REQUEST['m_key']) . "%' or ";
   
        $f2.="kehu_id like '%" . trim($_REQUEST['m_key']) . "%' or ";
   
        $f2.="bz like '%" . trim($_REQUEST['m_key']) . "%' or ";
   
        $f2.="user_name like '%" . trim($_REQUEST['m_key']) . "%' ";
    ...
    if(isset($_REQUEST['huifang_time_1']) and isset($_REQUEST['huifang_time_2']))
    {
        if(trim($_REQUEST['huifang_time_1'])=='' and trim($_REQUEST['huifang_time_2'])=='')
        {
            
        }
        else
        {
            $filer1 .=" and (huifang_time >= '" . $_REQUEST['huifang_time_1']." 00:00:00' and huifang_time <= '" . $_REQUEST['huifang_time_2']." 23:59:59')";  
        }  
    }
    ...
    $filer = " where kehu_id='".$_REQUEST['kehu_id']."' $filer1 ";
    $action_list = array();
...
function get_kehuhuifang_mx($ma,$sql)
{   
...
function update_kehuhuifang_mx($tb,$field,$u_id,$time_f)
{   
...
function insert_kehuhuifang_mx($tb,$field,$time_f)
{
    $array = explode(",",$field);
