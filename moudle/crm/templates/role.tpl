...
<form method="POST" action="role.php?act=role_post">
   <table class="table" width="100%" border="0">
      ...
      <tr><td colspan="4" style="background-color:    #d6e7fc;"><b>档案管理</b></td></tr>
      <input name="role_sn"  value="{$role_sn}" type="hidden"/>
        <tr>
            <td style="width:150px;"><input  type="checkbox" class="checkthis"  name="checkthis"/>&nbsp;&nbsp;&nbsp;业务档案</td>
            <td>
        ...
        <tr>
            <td style="width:150px;"><input  type="checkbox" class="checkthis"  name="checkthis"/>&nbsp;&nbsp;&nbsp;费用计算工具</td>
            <td>
            {foreach from=$list item=list}
            {if $list.sort_no==2}
            <span style="width:200px;"> {if $list.val==1}<input  type="checkbox" name='chk_list' checked="checked"  />{else}<input  name='chk_list' type="checkbox"   />{/if}&nbsp;&nbsp;&nbsp;{$list.action_name}&nbsp;&nbsp;&nbsp;
      ...
      <tr><td colspan="4" style="background-color:    #d6e7fc;"><b>报表中心</b></td></tr>
        <tr>
            <td style="width:150px;"><input  type="checkbox" class="checkthis"  name="checkthis"/>&nbsp;&nbsp;&nbsp;报表中心</td>
            <td>
            {foreach from=$list item=list}
            {if $list.sort_no==7}
            <span style="width:200px;"> {if $list.val==1}<input  type="checkbox" name='chk_list' checked="checked"  />{else}<input  name='chk_list' type="checkbox"   />{/if}&nbsp;&nbsp;&nbsp;{$list.action_name}&nbsp;&nbsp;&nbsp;
      ...
      <tr><td colspan="4" style="background-color:    #d6e7fc;"><b>系统设置</b></td></tr>
