...
<div class="demo">	
    ...
    <tr>
    <tr><td width="150">登陆名</td><td>
    <input  name="user_name3" type="hidden" value="{$admin_user_mx.user_name}"  id="user_name3"/>{$admin_user_mx.user_name}
   </td></tr>
    <tr><td width="150">用户名</td><td><textarea  name="user_name2" style="width: 300px; height: 50px;">{$admin_user_mx.user_name2}</textarea></td></tr>
    </tr>
    
    <tr><td width="150">邮箱</td><td><input  name="email" value="{$admin_user_mx.email}" /></td></tr>
      <tr><td width="150">系统管理员</td><td><input  name="is_admin"  type="checkbox" {if $admin_user_mx.is_admin==1}checked="checked"{/if} /></td></tr>
...
<tr  ><td width="200">用户代码<a style="color: red;">&nbsp;(添加后代码默认无法修改)</a></td><td><input id="user_code"  name="user_code" type="text"/><a style="color:red;">*</a></td></tr>
    ...
    <tr><td width="150">邮箱</td><td><input  name="email" /></td></tr>
      <tr><td width="150">系统管理员</td><td><input  name="is_admin"  type="checkbox" /></td></tr>
