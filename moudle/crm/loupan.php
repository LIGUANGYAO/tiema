...
if ($_REQUEST['g'] == 'default') {
    ...
    $yongtu= trim($_REQUEST['yongtu']);    
    if($yongtu=='')
    {
        $yongtu='';
    }
    $smarty->assign('yongtu',$yongtu);
