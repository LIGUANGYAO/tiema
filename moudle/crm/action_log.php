...
//设定传入主参数
$g_add=substr(md5("a_action_log"),0,17); //添加参数
$g_e=substr(md5("e_action_log"),0,17); //编辑
$g_post=substr(md5("post_action_log"),0,17); //修改保存
$g_d=substr(md5("d_action_log"),0,17); //删除
$g_in=substr(md5("in_action_log"),0,17); //插入
$g_xs=substr(md5("xs_action_log"),0,17); //显示
