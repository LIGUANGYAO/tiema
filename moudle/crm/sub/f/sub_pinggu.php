...
function get_pinggu_list($Nu, $ma, $sql)
{
    ...
    if (isset($_REQUEST['m_key'])) {
        ...
        $f2="";
        $f2.="pinggu_sn like '%" . trim($_REQUEST['m_key']) . "%' or ";
   
        $f2.="pinggu_name like '%" . trim($_REQUEST['m_key']) . "%' or ";
   
        $f2.="kehu_name like '%" . trim($_REQUEST['m_key']) . "%' or ";
   
        $f2.="pinggu_obj like '%" . trim($_REQUEST['m_key']) . "%' ";
...
function update_pinggu_mx($tb,$field,$u_id,$time_f)
{   
...
function insert_pinggu_mx($tb,$field,$time_f)
{
    $array = explode(",",$field);
