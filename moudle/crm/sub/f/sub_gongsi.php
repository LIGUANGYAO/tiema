...
function get_gongsi_list($Nu, $ma, $sql)
{
    ...
    if (isset($_REQUEST['m_key'])) {
        ...
        $f2="";
        $f2.="gongsi_sn like '%" . trim($_REQUEST['m_key']) . "%' or ";
   
        $f2.="gongsi_name like '%" . trim($_REQUEST['m_key']) . "%' ";
...
function update_gongsi_mx($tb,$field,$u_id,$time_f)
{   
...
function insert_gongsi_mx($tb,$field,$time_f)
{
    $array = explode(",",$field);
