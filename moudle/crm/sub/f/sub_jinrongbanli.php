...
function get_jinrongbanli_list($Nu, $ma, $sql)
{
    ...
    if (isset($_REQUEST['m_key'])) {
        ...
        $f2="";
        $f2.="jinrongbanli_sn like '%" . trim($_REQUEST['m_key']) . "%' or ";
   
        $f2.="jinrongbanli_name like '%" . trim($_REQUEST['m_key']) . "%' ";
    ...
    if(isset($_REQUEST['banli_time_1']) and isset($_REQUEST['banli_time_2']))
    {
        if(trim($_REQUEST['banli_time_1'])=='' and trim($_REQUEST['banli_time_2'])=='')
        {
            
        }
        else
        {
            $filer1 .=" and (banli_time >= '" . $_REQUEST['banli_time_1']."' and banli_time <= '" . $_REQUEST['banli_time_2']."')"; 
        }   
    }
...
function get_jinrongbanli_mx($ma,$sql)
{   
...
function update_jinrongbanli_mx($tb,$field,$u_id,$time_f)
{   
...
function insert_jinrongbanli_mx($tb,$field,$time_f)
{
    $array = explode(",",$field);
