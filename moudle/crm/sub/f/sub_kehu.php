...
function get_kehu_list($Nu, $ma, $sql)
{
    ...
    if (isset($_REQUEST['m_key'])) {
        ...
        $f2="";
        $f2.="kehu_sn like '%" . trim($_REQUEST['m_key']) . "%' or ";
    ...
    if(isset($_REQUEST['sl_1']) and isset($_REQUEST['sl_2']))
    {
        if(trim($_REQUEST['sl_1'])=='' and trim($_REQUEST['sl_2'])=='')
        {
            
        }
        else
        {
            $filer1 .=" and (sl >= '" . trim($_REQUEST['sl_1'])."' and sl <= '" . trim($_REQUEST['sl_2'])."')";  
        }  
    }
