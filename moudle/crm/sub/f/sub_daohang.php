...
function get_daohang_list($Nu, $ma, $sql)
{
    ...
    if (isset($_REQUEST['m_key'])) {
        ...
        $f2="";
        $f2.="daohang_sn like '%" . trim($_REQUEST['m_key']) . "%' or ";
   
        $f2.="daohang_name like '%" . trim($_REQUEST['m_key']) . "%' or ";
   
        $f2.="url like '%" . trim($_REQUEST['m_key']) . "%' or ";
...
function get_daohang_mx($ma,$sql)
{   
...
function update_daohang_mx($tb,$field,$u_id,$time_f)
{   
...
function insert_daohang_mx($tb,$field,$time_f)
{
    $array = explode(",",$field);
