...
function get_yinhang_list($Nu, $ma, $sql)
{
    ...
    if (isset($_REQUEST['m_key'])) {
        ...
        $f2="";
        $f2.="yinhang_sn like '%" . trim($_REQUEST['m_key']) . "%' or ";
   
        $f2.="yinhang_name like '%" . trim($_REQUEST['m_key']) . "%' ";
...
function get_yinhang_mx($ma,$sql)
{   
...
function update_yinhang_mx($tb,$field,$u_id,$time_f)
{   
...
function insert_yinhang_mx($tb,$field,$time_f)
{
    $array = explode(",",$field);
