...
function get_loupan_list($Nu, $ma, $sql)
{
    ...
    if (isset($_REQUEST['m_key'])) {
        ...
        $f2="";
        $f2.="loupan_name like '%" . trim($_REQUEST['m_key']) . "%' or ";
   
        $f2.="weizhi like '%" . trim($_REQUEST['m_key']) . "%' ";
    ...
    if(isset($_REQUEST['loupan_name']))
    {
            $filer1 .=" and loupan_name like '%" . trim($_REQUEST['loupan_name'])."%'";    
    }
 
 

    if(isset($_REQUEST['yongtu']))
    {
        if(trim($_REQUEST['yongtu'])=='')
        {
            
        }
        else
        {
            $filer1 .=" and yongtu = '" . trim($_REQUEST['yongtu'])."'";    
        }
    ...
    if(isset($_REQUEST['dianti']))
    {
        if(trim($_REQUEST['dianti'])=='')
        {
            
        }
        else
        {
            $filer1 .=" and dianti = '" . trim($_REQUEST['dianti'])."'";    
        }
...
function update_loupan_mx($tb,$field,$u_id,$time_f)
{   
...
function insert_loupan_mx($tb,$field,$time_f)
{
    $array = explode(",",$field);
