...
///修改1,查询语句
//sort_no,tzsy 要记得添加
    $sql="select user_id,user_code,user_name,user_name2,sort_no,tzsy,add_time,last_update,last_update_2,email,is_admin from admin_user ";
...
if ($_REQUEST['act'] == 'edit') {
    ...
    ///修改2,查询语句
    $sql="select user_id,user_code,user_name,user_name2,sort_no,email,tzsy,add_time,last_update,is_admin,last_update_2
  from admin_user ";
...
if ($_REQUEST['act'] == 'post') {
    ...
    update_admin_user_mx("admin_user","sort_no,user_name2,email,is_admin","user_code",$time_field);
...
if ($_REQUEST['act'] == 'post_add') {
    ...
    $get_one=" select user_code from admin_user where user_code ='".$user_code."' or user_name='".$_REQUEST['user_name3']."' ";
    ...
    if(empty($res))
    {
       ...
       // array("type"=>"2","field"=>"last_update","method"=>"2"),
        ...
        //修改4，增加语句
        //保存修改后商品明细
        insert_admin_user_mx("admin_user","user_code,user_name2,email,is_admin,sort_no",$time_field);
