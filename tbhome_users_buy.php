...
require (dirname(__file__) . '/sub/tbhome_sub_insurance.php');
...
if ($_REQUEST['act'] == 'default') {
    ///修改1,查询语句
    //sort_no,tzsy 要记得添加
    $tbhome_sql = "select * from tbhome_users_insurance";
...
*/
$flkf=$db;
    $users_buy_list = get_activity_list($Num, "tbhome_users_insurance", $tbhome_sql);//activity 改为 tbhome_users_insurance
/*
 ...
 */
    ...
    $smarty->assign('users_buy_list', $users_buy_list['items']);
    $smarty->assign('fall', 1);
    $smarty->assign('title', $aaa);
    $smarty->assign('p_Array', $users_buy_list['page']);
    $smarty->display('tbhome_users_buy.tpl');


}

if ($_REQUEST['act'] == 'add_users_buy_list') {
  ...
  //  $smarty->assign('activity_mx', $activity_mx);
    $smarty->assign('fall', 'add_users_buy_list');
    $smarty->display('tbhome_insurance.tpl');
}
