...
//		curl_setopt($ch,CURLOPT_SSL_VERIFYHOST,2);//严格校验
    ...
    public static function sendRedPack($inputObj, $timeOut = 6)
	{
		...
		$response = self::postXmlCurl2($xml, $url, true, $timeOut);
    ...
    public static function Transfers($inputObj, $timeOut = 6)
	{
     ...
     private static function postXmlCurl2($xml, $url, $useCert = false, $second = 30)
	{		
		$ch = curl_init();
		//设置超时
		curl_setopt($ch, CURLOPT_TIMEOUT, $second);
...
//		curl_setopt($ch,CURLOPT_SSL_VERIFYHOST,2);//严格校验
		...
		if($useCert == true){
            ...
            curl_setopt($ch,CURLOPT_CAINFO,WxPayConfig::CAKEY_PATH);
