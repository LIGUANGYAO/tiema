	...
	exit;
        ...
        if($uinfo['wx_pay']==0)
        {
            ...
            //计算上级分成
                ...
                //生成推广二维码
            require_once (dirname(dirname(dirname(__file__))) . '/sub/sub_cj_qrcode.php');
            $tk = new getArr();
            ...
            $getqrcid = $GLOBALS['db']->query($getqrcid);
             ...
             $local_file = fopen((dirname(dirname(dirname(__file__))).'/upload/cj_qrcode/agent/').$filename, 'w');
             if (false !== $local_file){
