...
//    var $max_cache_time = 300; // 最大的缓存时间，以秒为单位
    ...
    {
        $this->cls_pro_mysql($dbhost, $dbuser, $dbpw, $dbname, $charset, $pconnect, $quiet);
    }

    function cls_pro_mysql($dbhost, $dbuser, $dbpw, $dbname = '', $charset = 'gbk', $pconnect = 0, $quiet = 0)
    {
    ...
    function connect($dbhost, $dbuser, $dbpw, $dbname = '', $charset = 'utf8', $pconnect = 0, $quiet = 0)
    {
        ...
        else
        {
            ...
            if (PHP_VERSION >= '4.2')
            {
                $this->link_id = @mysql_connect($dbhost, $dbuser, $dbpw, true,131072);
            }
            else
            {
    ...
    function ErrorMsg($message = '', $sql = '')
    {
        if ($message)
        {
            echo "<b>OpenShop info</b>: $message\n\n<br /><br />";
        }
        else
        {
