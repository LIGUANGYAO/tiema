<?php
    ...
    $activity = "select a.activity_sn,a.activity_name,a.tzsy,a.start_time,a.end_time,a.hd_number,b.* from activity a , activity_mx b  where a.ac_lx=3 and a.tzsy=0 and (a.start_time<='".$whell."' and a.end_time>'".$whell."') and a.activity_sn=b.p_id";
