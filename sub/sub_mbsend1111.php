...
$senddata = array("first" => array("value" => "恭喜您有新的下级加入", "color" => "#92B901"),
        ...
        "remark" => array("value" => "通过【".$sanji['nick_name']."】->【".$bj['nick_name']."】推荐", "color" => "#92B901"));
...
$senddata2 = array("first" => array("value" => "恭喜您有新的下级加入", "color" => "#92B901"),
        ...
        "keyword3" => array("value" => "", "color" => "#92B901"),
        "remark" => array("value" => "通过【".$erji['nick_name']."】->【".$sanji['nick_name']."】->【".$bj['nick_name']."】推荐", "color" => "#92B901"));
...
$senddata3 = array("first" => array("value" => "恭喜您有新的下级加入", "color" => "#92B901"),
        ...
        "keyword3" => array("value" =>"", "color" => "#92B901"),
        "remark" => array("value" => "通过【".$yiji['nick_name']."】->【".$erji['nick_name']."】->【".$sanji['nick_name']."】->【".$bj['nick_name']."】推荐", "color" => "#92B901"));
