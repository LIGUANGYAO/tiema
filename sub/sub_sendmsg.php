...
//                    error from sendmsg_users where is_send =0 and p_id='".$p_id."'";
    ...
    $sum2="select count(openid) as timeout from sendmsg_users where err_code='45015' and p_id='".$p_id."'";
    $sum2 = $GLOBALS['db']->getRow($sum2);
    
    
    $sum3="select count(openid) as send_su from sendmsg_users where err_code='0' and p_id='".$p_id."'";
