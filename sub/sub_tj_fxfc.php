...
function get_tj_fxfc_list($Nu, $ma, $sql)
{
    ...
    $sql_c = "select count(a.order_sn) as c_cl from weixiaodian a inner join cj_qrcode_stat b on a.buyer_openid=b.openid group by a.order_sn order by b.add_time desc  ";
    ...
    $sql = $sql . $filer . " group by b.openid,a.order_sn order by b.add_time desc " . $obj['limit_obj'] .
        ";";
