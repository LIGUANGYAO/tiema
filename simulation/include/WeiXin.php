 ...
 *
 * 功能: 发送信息, 批量发送, 得到用户信息, 得到最近信息, 解析用户信息(fakeId)
 */
class WeiXin
{
    ...
    //https://mp.weixin.qq.com/cgi-bin/message?t=message/list&count=20&day=7&token=414344952&lang=zh_CN
	...
	public function getLatestMsgs($page = 0) {
		...
		$url = "https://mp.weixin.qq.com/cgi-bin/message?t=message/list&count=20&day=7&offset={$offset}&token={$this->webToken}&lang=zh_CN";
