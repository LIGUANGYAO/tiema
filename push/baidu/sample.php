...
$apiKey = "A0Topc9Gh0xamvlDh0S2ugsN";
$secretKey = "n2B3W8w3pSK3rCEzDmhsM61PknStSFbl";
...
function tiemal_pushMessage_android($user_id,$p_type=1,$msg='')
{
    global $apiKey;
    global $secretKey;
    $channel = new Channel($apiKey, $secretKey);
...
//    $message='{
//            			"title": "腾讯风铃",
//            			"description": "腾讯官方微信建站首页无线建站，如此简单！http://fl.qq.com/",
//            			"notification_basic_style":7,
//            			"open_type":0,
//            			"url":"http:www.baidu.com",
//                        "custom_content": {
...
//test_pushMessage_android('974656976131282862');
