...
<div class="demo">	
  ...
  <tr>
      <td>代码:</td>
      <td>
          <input disabled="true"  type="text" value="{$activity_mx.activity_sn}" /><input name="activity_sn" id="activity_sn"  type="hidden" value="{$activity_mx.activity_sn}" /><a style="color:red;">*</a>
      </td>
  <td width="150">开始时间</td>
      <td>
          <input  class="start_time" value="{$activity_mx.start_time}" name="start_time" type="text" id="control_date" size="20" maxlength="10" onclick="new Calendar().show(this);" readonly="readonly" /><a style="color:red;">*</a>
      </td>
  </tr>
 ...
 <tr>
     <td>名称:</td>
     <td>
         <input name="activity_name"  id="activity_name" type="text" value="{$activity_mx.activity_name}" /><a style="color:red;">*</a>
     </td>
 <td width="150">结束时间</td>
     <td>
         <input    class="end_time" value="{$activity_mx.end_time}" name="end_time" type="text" id="control_date" size="20" maxlength="10" onclick="new Calendar().show(this);" readonly="readonly" /><a style="color:red;">*</a>
     </td>
 </tr>
  ...
  <tr>
      <td>大转盘地址</td>
      <td  colspan="3">
          <textarea style="width:800px">{$url_this}</textarea>
  </tr>

 <tr>
     <td  colspan="4">  <input type="radio" name="ac_lx[]" id="dazhuanpan" value="1" />大转盘&nbsp;&nbsp;
