...
{if $fall==1}
 ...
 <form>
 <tr>
 <th style="text-align: left;border-right-style:none"><!--<input id="a_text" value="添加模板" type="button" onclick="location='appid.php?act=add_appid_list'" />&nbsp;<input id="down_hy" value="头像下载" type="hidden" />--></th>
     ...
     $("#text_sn").focus();
       $("#queding").click(function(){
        ...
        $("img[id='edit']").each(function (){
           ...
           window.location='tbhome_appid.php?act=edit&appid_sn='+encodeURI(encodeURI($(this).attr("name")));
