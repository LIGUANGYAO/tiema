...
<div class="demo">	
	    ...
	    <form name="myform" method="post" action="appid.php?act=post" enctype="multipart/form-data">
  ...
  <tr><td>代码:</td><td><input disabled="true"  type="text" value="{$appid_mx.appid_sn}" /><input name="appid_sn" id="appid_sn"  type="hidden" value="{$appid_mx.appid_sn}" /><a style="color:red;">*</a></td></tr>
  <tr><td>id:</td><td><input name="app_id"  id="app_id" type="text" value="{$appid_mx.app_id}" /><a style="color:red;">*</a></td></tr>
  <tr><td>secret:</td><td><textarea name="app_secret" id="app_secret" style="width:300px;height:150px;">{$appid_mx.app_secret}</textarea></td></tr>
</tr>
    ...
    <div align="center" style="padding: 10px;"><input  type="submit"  id="btn_queren2" value="确认" />&nbsp;<input  type="button" onclick="location='appid.php'" value="返回" /></div>
	</div>
...
<div class="demo">	
	...
	<div class="tabcon" id="leftcon"  >
    <div  id="m1"><table class="table" width="100%" border="0" >
    <form name="myform" method="post" action="appid.php?act=post_add" enctype="multipart/form-data">   
  <tr><td>代码:</td><td><input name="appid_sn" id="appid_sn"  type="text" /><a style="color:red;">*</a></td></tr>
  <tr><td>id:</td><td><input name="appid_id"  id="appid_id" type="text" /><a style="color:red;">*</a></td></tr>
  <tr><td>secret:</td><td><textarea name="appid_secret" id="appid_secret" style="width:300px;height:150px;"></textarea></td></tr>
   <tr><td>图文类型:</td><td>
