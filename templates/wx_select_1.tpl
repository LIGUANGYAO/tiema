...
$("#ysss").click(function ()
		...
		var s="";
		  ...
		  if( window.opener.document.all.qudao.value!='')
		  {
		  s=window.opener.document.all.qudao.value;
		  htmlobj=$.ajax({url:"wx_vouchers.php?act=ysss&type={$type}&s="+s+"&keyword="+encodeURI(encodeURI($("#b_ysss").val())),async:false,dataType: 'json'});
		  }
		  else
		  {
		  htmlobj=$.ajax({url:"wx_vouchers.php?act=ysss&type={$type}&keyword="+encodeURI(encodeURI($("#b_ysss").val())),async:false,dataType: 'json'});
		  }
           ...
           $("#select1").append("<option id='select1_1' name="+ o.dm+" value="+o.dm+" >"+ o.dm +"(" + o.mc +")</option>" );});
