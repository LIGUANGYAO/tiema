...
<ul class="user_ul">
 ...
 <ul class="user_ul">
      ...
      <li onclick="location.href='mcenter.php?act=order_search&openid={$op}'"><span class="user_s5">积分/订单</span></li>
        ...
        {if $fenxiao==0}
         <li  onclick="location.href='mcenter.php?act=jiameng&openid={$op}'"><span class="user_s4">我要加盟&nbsp;</span></li>
        {elseif $fenxiao==1}
         <li onclick="location.href='mcenter.php?act=fxfc&openid={$op}'"><span class="user_s4">推广二维码&nbsp;</span></li>
          <li onclick="location.href='mcenter.php?act=fxfc2&openid={$op}'"><span class="user_s4">分销商信息&nbsp;</span></li>
        {/if}
