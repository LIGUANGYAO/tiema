...
/*
    $sqlgh="select * from tbhome_wx_gh WHEN id = 1";
    ...
    if(isset($_REQUEST['order_sn']))
    {
       $order_sn=$_REQUEST['order_sn'];
        /*         $get_one=" select * from wx_order where order_sn ='".$order_sn."'";
                ...
                $amount1=$syx0*$rate1;//订单商业险金额 * 一级分成佣金比率 单位：分
                $order_sn1=WXMCHID.date("YmdHis").rand(1000,9999);//创建分成付款订单号
