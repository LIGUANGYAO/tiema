...
?>
            ...
            <div title="保险管理">
                ...
                <ul id="tree4" style="margin-top:3px;" >
                    <li isexpand="true"><span>成员名单</span>
                    <ul>
                        <!--li url="tbhome_users_buy.php"><span>购险者列表</span></li-->
                        <li url="tbhome_pay_log.php"><span>支出明细</span></li>
                        <li url="wx_order_list.php"><span>购险订单列表</span></li>
            ...
            <div title="关于">
                    <div style=" height:7px;"></div>         
                         ...
                         <a class="l-link" href="tbhome_login.php?act=log_out">注销</a>
