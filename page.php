<?php
    ...
    function get_page($obj,$pager_Size)
    {
        ...
        {   
            ...
            $now_PageNum=$pager_Total-$pager_StartNum+1;
...
//        )
        ...
        return  $page_Array=array('pager_Total'=>$pager_Total,'pager_Number'=>$pager_Number,'pager_PageID'=>$pager_PageID,'pager_PageID_ow'=>$pager_PageID_ow,'pager_PageID_next'=>$pager_PageID_next,'pager_Size'=>$pager_Size,'pager_StartNum'=>$pager_StartNum,'pager_EndNum'=>$pager_EndNum,'now_PageNum'=>$now_PageNum,'limit_obj'=>$limit_obj,'url'=>$url);
    }
